...
+ release version (CRAN)
	- syntax: `` ``r ''`r badge_cran("badger")` ``
	- badge: `r badge_cran_release("badger")` 
+ devel version
...
+ Downloads from CRAN
    - syntax: `` ``r ''`r badge_cran_download("badger")` ``
    - badge: `r badge_cran_download("badger")`
...
+ coveralls code coverage
	- syntax: `` ``r ''`r badge_coveralls("sdcTools/sdcMicro")` ``
	- badge: `r badge_coveralls("sdcTools/sdcMicro")`
+ code size
