...
### Package Version
  ...
  - release version (bioconductor)
      ...
      - badge:
        [![](https://img.shields.io/badge/release%20version-2.4.2-green.svg)](https://www.bioconductor.org/packages/ggtree)
  ...
  - devel version
      ...
      - badge:
        [![](https://img.shields.io/badge/devel%20version-0.1.0.991-blue.svg)](https://github.com/guangchuangyu/ggtree)
...
### Download stats for bioconductor
  ...
  - Total of total :)
      - syntax: `` `r badge_bioc_download("clusterProfiler", "total",
        "blue", "total")` ``
      - badge:
        [![](https://img.shields.io/badge/download-623917/total-blue.svg)](https://bioconductor.org/packages/stats/bioc/clusterProfiler)
  - Total of distinct IPs
      - syntax: `` `r badge_bioc_download("clusterProfiler", "total",
        "yellow")` ``
      - badge:
        [![](https://img.shields.io/badge/download-338768/total-yellow.svg)](https://bioconductor.org/packages/stats/bioc/clusterProfiler)
  - Monthly download of distinct IPs
      - syntax: `` `r badge_bioc_download("clusterProfiler", "month",
        "green")` ``
      - badge:
        [![](https://img.shields.io/badge/download-10720/month-green.svg)](https://bioconductor.org/packages/stats/bioc/clusterProfiler)
